...
Singleton {
    ...
    property string osLogo: Qt.resolvedUrl(`${Quickshell.shellDir}/donwaztok/assets/logo.svg`)
    ...
    FileView {
        ...
        onLoaded: {
            ...
            if (logo) {
                ...
                root.osLogo = Qt.resolvedUrl(`${Quickshell.shellDir}/donwaztok/assets/logo.svg`);
