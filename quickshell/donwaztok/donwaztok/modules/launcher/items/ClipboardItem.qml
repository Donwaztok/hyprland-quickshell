...
import "../../../../services" as RootServices
...
Item {
    ...
    readonly property bool isImage: RootServices.Cliphist.entryIsImage(root.modelData)
    ...
    StateLayer {
        ...
        function onClicked(): void {
            RootServices.Cliphist.copy(root.modelData);
    ...
    Item {
        ...
        Process {
            id: decodeProc
            command: ["bash", "-c", `[ -f '${root.decodePath}' ] || printf '${StringUtils.shellSingleQuoteEscape(root.modelData)}' | ${RootServices.Cliphist.cliphistBinary} decode > '${root.decodePath}'`]
