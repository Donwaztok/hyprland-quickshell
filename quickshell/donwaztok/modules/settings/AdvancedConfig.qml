...
ContentPage {
    ...
    ContentSection {
        icon: "colors"
        title: qsTr("Color generation")

        ConfigSwitch {
            buttonIcon: "hardware"
            text: qsTr("Shell & utilities")
        ...
        ConfigSwitch {
            ...
            StyledToolTip {
                text: qsTr("Shell & utilities theming must also be enabled")
            }
        }
        ConfigSwitch {
            buttonIcon: "terminal"
        ...
        ConfigSpinBox {
            icon: "gradient"
            text: qsTr("Terminal: Harmonize threshold")
        ...
        ConfigSpinBox {
            ...
            text: qsTr("Terminal: Foreground boost (%)")
