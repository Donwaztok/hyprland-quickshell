            ...
            Item {
                ...
                NavigationRail { // Window content with navigation rail and content pane
                    ...
                    FloatingActionButton {
                        ...
                        downAction: () => {
                            Qt.openUrlExternally(Directories.unifiedConfigUrl);
                        }
                        altAction: () => {
                            Quickshell.clipboardText = CF.FileUtils.trimFileProtocol(Directories.unifiedConfigPath);
                            fab.justCopied = true;
                        ...
                        StyledToolTip {
                            text: qsTr("Open the shell config file\nAlternatively right-click to copy path")
                        }
                    }
