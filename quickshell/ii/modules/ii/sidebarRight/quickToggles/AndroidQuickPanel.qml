...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "easyEffects", "darkMode", "cloudflareWarp", "gameMode", "screenSnip", "colorPicker", "mic", "audio", "notifications", "powerProfile","musicRecognition", "antiFlashbang"]
