...
Singleton {
    ...
    property string osLogo: Qt.resolvedUrl(`${Quickshell.shellDir}/caelestia/assets/logo.svg`)
    ...
    FileView {
        ...
        onLoaded: {
            ...
            if (Config.general.logo === "caelestia") {
                root.osLogo = Qt.resolvedUrl(`${Quickshell.shellDir}/caelestia/assets/logo.svg`);
